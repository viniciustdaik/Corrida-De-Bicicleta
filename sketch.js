...
function preload(){
  ...
  oppPink1Img = loadAnimation("./obstacles-opponents/pink/opponent1.png", 
  "./obstacles-opponents/pink/opponent2.png");
  oppPink2Img = loadAnimation("./obstacles-opponents/pink/opponent3.png");
  
  oppYellow1Img = loadAnimation("./obstacles-opponents/yellow/opponent4.png", 
  "./obstacles-opponents/yellow/opponent5.png");
  oppYellow2Img = loadAnimation("./obstacles-opponents/yellow/opponent6.png");
  
  oppRed1Img = loadAnimation("./obstacles-opponents/red/opponent7.png", 
  "./obstacles-opponents/red/opponent8.png");
  oppRed2Img = loadAnimation("./obstacles-opponents/red/opponent9.png");
  
  cycleBell = loadSound("bell.mp3");
  gameOverImg = loadImage("gameOver.png");

  oppCyan1Img = loadAnimation("./obstacles-opponents/cyan/opponent10.png", 
  "./obstacles-opponents/cyan/opponent11.png");
  oppCyan2Img = loadAnimation("./obstacles-opponents/cyan/opponent12.png");

  obstacle1img = loadImage("./obstacles-opponents/obstacle1.png");
  obstacle2img = loadImage("./obstacles-opponents/obstacle2.png");
  obstacle3img = loadImage("./obstacles-opponents/obstacle3.png");
}
